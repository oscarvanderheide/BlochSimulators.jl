...
Literate.markdown("docs/examples/dictionary.jl", "src"; flavor=Literate.CommonMarkFlavor())
Literate.markdown("docs/examples/signal.jl", "src"; flavor=Literate.CommonMarkFlavor())
